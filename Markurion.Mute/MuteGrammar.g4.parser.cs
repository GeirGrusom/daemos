...
namespace Markurion.Mute
{
    partial class MuteGrammarParser
    {
        ...
        protected ConstantExpression TransactionState(string state, ParserRuleContext ctx)
        {
            ...
            {
                case "initialize":
                    return new ConstantExpression(Markurion.TransactionState.Initialized, ctx);
                case "authorize":
                    return new ConstantExpression(Markurion.TransactionState.Authorized, ctx);
                case "complete":
                    return new ConstantExpression(Markurion.TransactionState.Completed, ctx);
                case "fail":
                    return new ConstantExpression(Markurion.TransactionState.Failed, ctx);
                case "cancel":
                    return new ConstantExpression(Markurion.TransactionState.Cancelled, ctx);
                default:
