...
RETURNING {SelectColumns};";
            ...
            cmd.Parameters.Add(new NpgsqlParameter("state", NpgsqlDbType.Integer) { IsNullable = false });
            cmd.Parameters.Add(new NpgsqlParameter("handler", NpgsqlDbType.Varchar) { IsNullable = true });
